...
class DocstringParser(ABC):
    ...
    def has_separate_yield_statement(self) -> bool:
        ...
        Returns:
            True if regular exressions for yiels and return statements are different.
        """
        patterns = self._Patterns()  # type: ignore[abstract]
        return patterns.RETURN != patterns.YIELDS
    ...
    def __init__(self, docstring: str) -> None:
        ...
        """
        self.source = cleandoc(docstring)
        ...
        if self.has_separate_yield_statement:
            yield_value_match = re.search(patterns.YIELDS, self._description)
    ...
    def determine(
        docstring: str,
    ) -> 'GoogleDocstringParser | ReSTDocstringParser':
    ...
    def yield_value(self) -> DocstringItem | None:
        """Value that is yielded from curren function.
    ...
    def args_data(self) -> dict[str, DocstringItem]:
        ...
        Returns:
            dict with argument name and it's desctiption.
        """
    ...
    def attrs_data(self) -> dict[str, DocstringItem]:
        ...
        Returns:
            dict with attribute name and it's desctiption.
        """
